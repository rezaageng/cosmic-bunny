        ...
        {data.length === 0 ? (
          ...
          <div className="space-y-4 ">
            {data.map((item) => (
              <div
                key={item.id}
                className="flex flex-col space-y-6 rounded-lg bg-zinc-900 p-4 sm:flex-row sm:space-y-0 sm:space-x-6 sm:justify-between"
              >
                <Link
                ...
                >
                  <Image
                    className="aspect-[2] w-32 h-32 rounded object-cover sm:w-32 sm:h-32 lg:w-40 lg:h-40"
                    src={item.game.image}
                    alt={item.game.name}
                    width={128}
                    height={128}
                ...
                <div className="flex flex-col item space-y-2 sm:space-y-4">
                  <button
                    type="button"
